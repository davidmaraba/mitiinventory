                    ...
                    public void run() {
            			...
            			String restock=txtRestock.getText().toString().trim();
            			 ...
            			 params.add(new BasicNameValuePair("supplier_name", supplyName));
            			    params.add(new BasicNameValuePair("supplier_mobile", "0722221992"));
            			    params.add(new BasicNameValuePair("supplier_email","kim@gmail.com"));
            			    params.add(new BasicNameValuePair("supplier_id", restock));
