                    ...
                    public void run() {
            			...
            			String restock=txtRestock.getText().toString().trim();
            			 ...
            			 params.add(new BasicNameValuePair("med_name", medicineName));
            			    ...
            			    params.add(new BasicNameValuePair("med_quantity","200"));
            			    params.add(new BasicNameValuePair("med_brand","200"));
            			    params.add(new BasicNameValuePair("med_expiry_date","200"));
            			    params.add(new BasicNameValuePair("med_supplier_id","200"));
            			    params.add(new BasicNameValuePair("med_price","200"));


            			    
            			//&med_quantity=12&med_price&med_brand=sjs&med_expiry_date=12&&med_supplier_id=12&=400&
