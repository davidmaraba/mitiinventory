...
public class ViewMedicines extends ListActivity {
	...
	public ViewMedicinesAdapter adapter;
	...
	class LoadSubscriptions extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ViewMedicines.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					adapter = new ViewMedicinesAdapter(ViewMedicines.this,
