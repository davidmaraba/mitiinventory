...
public class CheckOutMainActivity extends Activity implements TextWatcher {
	...
	public CheckOutHomeAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		firstList=(ListView) this.findViewById(R.id.firstList);
		...
		String [] my={"my","mo"};
		arrayAdapter=new ArrayAdapter(this,android.R.layout.simple_list_item_1,my);
	...
	class LoadSubscriptions extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(CheckOutMainActivity.this);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					adapter = new CheckOutHomeAdapter(CheckOutMainActivity.this,
